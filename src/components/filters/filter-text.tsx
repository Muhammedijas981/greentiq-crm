    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        <input 
          ...
          className={`w-full bg-card border border-border rounded-lg py-2 pr-3 text-sm text-muted-foreground focus:outline-none focus:border-blue-500 ${icon ? 'pl-9' : 'pl-3'}`}
        />
      </div>
    </div>
  );
